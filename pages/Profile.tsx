    ...
    return (
      <div className="pb-24 bg-white min-h-screen text-right" dir="rtl">
        ...
        <div className="p-6 space-y-6">
           {banners.map(banner => (
             <div key={banner.id} className="relative rounded-[2.5rem] overflow-hidden shadow-xl h-48 border-4 border-white group">
                <img src={banner.imageUrl} className="w-full h-full object-cover transition-transform group-hover:scale-110" alt="" />
